                    ...
                    <table id="basic-datatables" class="display table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row['interest'] ?></td>
                                <td><?= $row['penalty'] ?></td>
                                <td><?= $row['terms'].' '.$row['terms2'] ?></td>

                                <td>

                                    <div class="form-button-action">

                                        <a type="button" href="#editLoantype" data-toggle="modal"
                                            class="btn btn-link btn-primary pl-1 pr-1" title="Edit Loan Type"
                                            onclick="editLoantype(this)" data-id="<?= $row['id'] ?>"
                                            data-typename="<?= $row['name'] ?>" data-interest="<?= $row['interest'] ?>"
                                            data-penalty="<?= $row['penalty'] ?>" data-terms="<?= $row['terms'] ?>"
                                            data-terms2="<?= $row['terms2'] ?>">

                                            <i class="fa fa-edit"></i>

                                        </a>

                                        <a type="button" href="<?= site_url("loans/delete_loan_type/".$row['id']) ;?>"
                                            data-toggle="tooltip"
