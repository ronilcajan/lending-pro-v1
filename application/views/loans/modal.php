            ...
            <div class="modal-body">
                <form method="POST" id="create_loan_form" action="<?= site_url('loans/create_loan') ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cname" id="cmaker" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Co-Maker Name</label>
                                <input type="text" class="form-control" name="cname1" id="cmaker1"
                                    placeholder="Enter name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="principal" required placeholder="Enter amount"
                            min="1" id="principal">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Select</label>
                                <select class="form-control" name="terms2" id="terms2" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="interest" placeholder="Enter interest"
                                    required min="0" id="interest">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="penalty" id="penalty"
                                    placeholder="Enter penalty" required min="0">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-right" name="monthly" id="monthly"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-right" name="total" id="total_amount"
                                    style="pointer-events: none;">
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="loanType" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
...
<div class="modal fade" id="addLoantype" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="POST" action="<?= site_url('loans/create_loan_type') ?>" id="create_loan_type_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Penalty</label>
                                <input type="number" class="form-control" name="penalty" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Select</label>
                                <select class="form-control" name="terms2">
                                    <option value="day/s">Day/s</option>
                                    <option value="month/s">Month/s</option>
                                </select>
                            </div>
...
<div class="modal fade" id="editLoantype" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="POST" action="<?= site_url('loans/update_loan_type') ?>" id="edit_loan_type_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Select</label>
                                <select class="form-control" name="terms2" id="loan_type_terms2">
                                    <option value="day/s">Day/s</option>
                                    <option value="month/s">Month/s</option>
                                </select>
                            </div>
