            ...
            <div class="modal-body">
                <form method="POST" id="create_loan_form" action="<?= site_url('loans/create_loan') ?>">
                    <div class="form-group">
                        ...
                        <select class="form-control borrowers" name="borrowers_id"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cname" id="cmaker" required
                                    placeholder="Enter name" style="pointer-events: none;">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="loan_type" id="loan_type" required
                            onchange="getLoanTypes(this)" style="pointer-events: none;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="penalty" id="penalty"
                                    placeholder="Enter penalty" required min="0" style="pointer-events: none;">
                            </div>
                            <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="pay_loan_form" action="<?= site_url('payments/save_payment') ?>">
                    ...
                    <div class="form-group">
                        <label>Notes(Optional)</label>
                        <input type="text" class="form-control" name="notes" value="Payment">
                    </div>
            </div>
            <div class="modal-footer">
                <input type="hidden" id="loan_id_m" name="loan_id">
                <input type="hidden" id="pment_id" name="pment_id">
                <input type="hidden" id="p_terms" name="terms">
                <input type="hidden" id="p_terms2" name="terms2">
