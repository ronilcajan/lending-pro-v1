    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-primary">
                ...
                <li
                    class="nav-item <?= $current_page == 'borrowers' || $current_page == 'borrowers_profile' ? 'active' : null ?>">
                ...
                <li
                    class="nav-item <?= $current_page == 'loans' || $current_page == 'loan_details' ? 'active' : null ?>">
